...
| **Phase 11** | **[Phase 11 — Secure Live Model Arena](file:///c:/Users/ardao/Desktop/llm-replay/docs/phases/phase-11-interactive-live-arena.md)** | Salt-okunur UI'dan ayrı Arena komutu, iki allowlisted modelin güvenli karşılaştırması ve yalnızca CLI ile etkinleşen dataset capture. |
| **Phase 11C** | **[Phase 11C — Web Model Selection](file:///c:/Users/ardao/Desktop/llm-replay/docs/phases/phase-11c-web-model-selection.md)** | `make arena` ile tek komut başlangıcı, web dropdown'larından server-allowlisted model seçimi. |
